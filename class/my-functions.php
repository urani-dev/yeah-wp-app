...
class olbInitFunction {
	...
	public function __construct() {
		...
		add_action('widgets_init', function(){ register_widget("olbWidgetMembersMenu"); });
		add_action('widgets_init', function(){ register_widget("olbWidgetTeachersMenu"); });
		add_action('widgets_init', function(){ register_widget("olbWidgetAdminsMenu"); });
	...
	public function init(){
		...
		add_action('publish_page', array('olbHookAction', 'saveRoomURL'));
		add_action('trash_page', array('olbHookAction', 'deleteRoomURL'));
		...
		add_filter( 'olb_can_cancellation',  array( 'olbTimetable', 'canCancellation' ), 10, 4 );
