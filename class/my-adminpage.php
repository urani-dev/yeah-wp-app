...
class olbAdminPage {
	...
	public static function settingPage($args = null){
		...
		if ( 'POST' == $_SERVER['REQUEST_METHOD'] ) {
			if ( ! empty( $_POST ) && check_admin_referer( OLBsystem::TEXTDOMAIN ) ) {
				// Reset
				...
				// Update
					...
					$olb_options = get_option($options_key);
					$before = $olb_options;
					foreach ( $_POST['olb_options'] as $key => $val ) {
						if ( 'mail' == $options_group ) {
							$olb_options[ $options_group ][ $key ] = $val;
						} else {
							$olb_options[ $options_group ][ $key ] = wp_filter_nohtml_kses( $val );
						}
					}
...
<td>
<input type="text" name="olb_options[starttime]" id="" value="<?php echo esc_attr( $options['starttime'] ); ?>" size="5" /> ex. 09:00
...
<td>
<input type="text" name="olb_options[endtime]" id="" value="<?php echo esc_attr( $options['endtime'] ); ?>" size="5" /> ex. 18:00
<p class="description"></p>
</td>
</tr>
...
<td>
<input type="text" name="olb_options[interval]" id="" value="<?php echo intval( $options['interval'] ); ?>" size="5" /> 
...
<td>
<input type="text" name="olb_options[reserve_deadline]" id="" value="<?php echo intval( $options['reserve_deadline'] ); ?>" size="5" /> 
...
<td>
<input type="text" name="olb_options[cancel_deadline]" id="" value="<?php echo intval( $options['cancel_deadline'] ); ?>" size="5" /> 
<?php _e('minutes before', OLBsystem::TEXTDOMAIN); ?>
<p class="description"></p>
</td>
</tr>
...
<td>
<input type="text" name="olb_options[limit_per_day]" id="" value="<?php echo intval( $options['limit_per_day'] ); ?>" size="5" />
...
<td>
<input type="text" name="olb_options[limit_per_month]" id="" value="<?php echo intval( $options['limit_per_month'] ); ?>" size="5" />
<?php _e( 'empty (or 0) is unlimited', OLBsystem::TEXTDOMAIN); ?>
<p class="description"></p>
</td>
</tr>
...
<td>
<input type="text" name="olb_options[ticket_metakey]" id="" value="<?php echo esc_attr( $options['ticket_metakey'] ); ?>" size="5" /> ex. 'olbticket'
<p class="description"></p>
</td>
</tr>
...
<td>
<input type="text" name="olb_options[ticket_expire]" id="" value="<?php echo intval( $options['ticket_expire'] ); ?>" size="5" /><?php _e("Days.", OLBsystem::TEXTDOMAIN); ?> ex. 60(Days)
...
<td>
<input type="text" name="olb_options[preserve_past]" id="" value="<?php echo intval( $options['preserve_past'] ); ?>" size="5" />
...
<td>
<input type="text" name="olb_options[room_per_page]" id="" value="<?php echo intval( $options['room_per_page'] ); ?>" size="5" />
<p class="description"></p>
</td>
</tr>
...
<th scope="row">&nbsp;</th>
<td>
<?php wp_nonce_field( OLBsystem::TEXTDOMAIN ); ?>
...
<td>
<input type="text" name="olb_options[daily_schedule_page]" id="" value="<?php echo esc_attr( $options['daily_schedule_page'] ); ?>" />
<p class="description">
...
<td>
<input type="text" name="olb_options[reserve_form_page]" id="" value="<?php echo esc_attr( $options['reserve_form_page'] ); ?>" />
<p class="description">
...
<td>
<input type="text" name="olb_options[cancel_form_page]" id="" value="<?php echo esc_attr( $options['cancel_form_page'] ); ?>" />
<p class="description">
...
<td>
<input type="text" name="olb_options[report_form_page]" id="" value="<?php echo esc_attr( $options['report_form_page'] ); ?>" />
<p class="description">
...
<td>
<input type="text" name="olb_options[edit_schedule_page]" id="" value="<?php echo esc_attr( $options['edit_schedule_page'] ); ?>" />
<p class="description">
...
<td>
<input type="text" name="olb_options[members_info_page]" id="" value="<?php echo esc_attr( $options['members_info_page'] ); ?>" />
<p class="description">
...
<td>
<input type="text" name="olb_options[member_page]" id="" value="<?php echo esc_attr( $options['member_page'] ); ?>" size="20" />
...
<td>
<input type="text" name="olb_options[login_page]" id="" value="<?php echo esc_attr( $options['login_page'] ); ?>" size="20" />
<p class="description">
...
<td>
<input type="text" name="olb_options[from_email]" id="" value="<?php echo esc_attr( $options['from_email'] ); ?>" />
<p class="description"></p>
</td>
</tr>
...
<td>
<textarea name="olb_options[signature]" id=""  rows="10" cols="50" ><?php echo esc_textarea( $options['signature'] ); ?></textarea>
<p class="description"></p>
</td>
</tr>
...
<td>
<input type="text" name="olb_options[reservation_subject]" id="" value="<?php echo esc_attr( $options['reservation_subject'] ); ?>" size="50" />
<p class="description">
</td>
</tr>
...
<td>
<input type="text" name="olb_options[reservation_subject_to_teacher]" id="" value="<?php echo esc_attr( $options['reservation_subject_to_teacher'] ); ?>" size="50" />
<p class="description"></p>
</td>
</tr>
...
<td>
<textarea name="olb_options[reservation_message]" id=""  rows="10" cols="50" ><?php echo esc_textarea( $options['reservation_message'] ); ?></textarea>
<p class="description"></p>
</td>
</tr>
...
<th scope="row"><?php _e('Subject', OLBsystem::TEXTDOMAIN); ?></th>
<td>
<input type="text" name="olb_options[cancel_subject]" id="" value="<?php echo esc_attr( $options['cancel_subject'] ); ?>" size="50" />
<p class="description"></p>
</td>
</tr>
...
<th scope="row"><?php _e('Subject to teacher', OLBsystem::TEXTDOMAIN); ?></th>
<td>
<input type="text" name="olb_options[cancel_subject_to_teacher]" id="" value="<?php echo esc_attr( $options['cancel_subject_to_teacher'] ); ?>" size="50" />
<p class="description"></p>
</td>
</tr>
...
<th scope="row"><?php _e('Message', OLBsystem::TEXTDOMAIN); ?></th>
<td>
<textarea name="olb_options[cancel_message]" id=""  rows="10" cols="50" ><?php echo esc_textarea( $options['cancel_message'] ); ?></textarea>
<p class="description"></p>
</td>
</tr>
...
<th scope="row"><?php _e('Subject', OLBsystem::TEXTDOMAIN); ?></th>
<td>
<input type="text" name="olb_options[cancel_subject_by_teacher]" id="" value="<?php echo esc_attr( $options['cancel_subject_by_teacher'] ); ?>" size="50" />
<p class="description"></p>
</td>
</tr>
...
<th scope="row"><?php _e('Subject to teacher', OLBsystem::TEXTDOMAIN); ?></th>
<td>
<input type="text" name="olb_options[cancel_subject_by_teacher_to_teacher]" id="" value="<?php echo esc_attr( $options['cancel_subject_by_teacher_to_teacher'] ); ?>" size="50" />
<p class="description"></p>
</td>
</tr>
...
<th scope="row"><?php _e('Message', OLBsystem::TEXTDOMAIN); ?></th>
<td>
<textarea name="olb_options[cancel_message_by_teacher]" id=""  rows="10" cols="50" ><?php echo esc_textarea( $options['cancel_message_by_teacher'] ); ?></textarea>
<p class="description"></p>
</td>
</tr>
...
<td>
<input type="text" name="olb_options[send_to_admin_too]" id="" value="<?php echo esc_attr( $options['send_to_admin_too'] ); ?>" size="30" style="width:auto;margih-right:10px" /> ex. <?php echo get_option('admin_email'); ?>
